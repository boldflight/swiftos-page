<div class="relative">
	<div class="bg-gray-50 dark:bg-gray-950 border-gradient rounded-xl p-4">
...
<style>
	...
	.border-gradient::after {
		...
		--highlight-color: rgb(249 115 22); /* orange-500 */
	...
	:global(.dark) .border-gradient::after {
		--border-color: rgb(55 65 81); /* gray-700 */
		--highlight-color: rgb(156 163 175); /* gray-400 */
	}
